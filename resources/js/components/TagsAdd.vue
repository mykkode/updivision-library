<template>
		...
		<div class = "content">
			<h2 class="title is-2">Add Tag</h2>
		...
		<form action="/tags/store" method="POST">
			...
			<div class="field">
		        ...
		        <div class="control has-icons-left">
		            <input id="tag_name" name="tag_name" class="input" type="text" placeholder="Tag Name" required>
		        ...
		        <div class="control">
		            <textarea id="tag_description" name = "tag_description" class="textarea" type="text" placeholder="Enter Description" rows="10" required></textarea>
		        </div>
